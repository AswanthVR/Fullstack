     ...
     sm:rounded-2xl w-full shadow-2xl md:p-[10px] lg:p-[50px] pb-[30px] justify-between  rounded-3xl' >
           ...
           <h1 className='md:hidden mt-10 block text-3xl font-bold text-teal-400 text-center'>EZpay</h1>
      {
        !user ?(loading ?(
          ...
          className='outline-none border-l-0 border-r-0 border-t-0 md:mb-0 mb-10 mt-3 
        ...
        (
          ...
          placeholder='Enter Your OTP'  className=' outline-none flex md:mb-0 mb-10  placeholder-s4 w-2/3 h-10 rounded-md border-2 place-content-center border-gray-300'/>
          </div>
