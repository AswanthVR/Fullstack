  ...
  return (
    ...
    <div className='md:flex flex-row w-  md:h-screen md:p-10 md:px-20 p-5 bg-teal-50'>
        <div className='bg--500 flex flex-col h-screen md:w-1/2 justify-evenly '>
                ...
                <div>
                    <h1 className='md:text-5xl text-2xl text-teal-900 font-bold -mb-24 -mt-10'>Instant Prepaid Mobile Recharge Solution</h1>
                </div>
                <div>
                    <p className='text-black  md:text-xl'>Empower your connectivity with seamless prepaid mobile recharges, where convenience meets innovation.</p>
                </div>
        ...
        <section className='bg-white h-full w-full rounded-3xl  md:p-10 p-10 shadow-2xl'>
            <h1 className='text-sec font-bold text-2xl'>Mobile Recharge</h1>
